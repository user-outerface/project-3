          ...
          {((res !== undefined) && (this.props.nonSpec === "true")) ? res[0] && res[0].map(posts => {
            ...
            return (<section key={posts._id}>
              <Carded 
                ...
                postname={posts.title ? <Markdown source={`[${posts.title}](/posts/t&gq=${posts.genre.replace(/\s+/g,"%20")}/tpm&n=${posts._id})`} /> : <AnchorTag href={"./posts/t&gq=" + posts.genre} children={posts.genre} /> }
